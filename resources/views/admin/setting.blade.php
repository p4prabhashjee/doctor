                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" id="settingform" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Script markup</label>
                                    <textarea class="form-control" name="script_markup">{{ old('script_markup',isset($setting->script_markup) ? $setting->script_markup : '' )}}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Google tag manager</label>
                                    <textarea class="form-control" name="google_tag_manager">{{ old('google_tag_manager',isset($setting->google_tag_manager) ? $setting->google_tag_manager : '' )}}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Google analytics</label>
                                    <textarea class="form-control" name="google_analytics">{{ old('google_analytics',isset($setting->google_analytics) ? $setting->google_analytics : '' )}}</textarea>
                                </div>
