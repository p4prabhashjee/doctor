...
<div class="main-content">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('sub_category_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.table_data').DataTable({
                ...
                ajax: {
                    url: "{{ url('/admin/sub-specialities-data') }}",
                    data: function(d) {
            ...
            $(document).on("click", ".delete-button", function(e) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/sub-specialities/delete') }}",
                            datatType: 'json',
                            type: 'GET',
                            data: {
                                'id': id,
    ...
    <script type="text/javascript">
        function changeStatus(id, status) {
            ...
            $.ajax({
                url: "{{ url('admin/sub-specialities/status') }}",
                type: 'GET',
                data: {
                    'id': id,
                    'status': status,
                ...
                success: function(res) {
                    if (res == "Success") {
                        swal({
                                title: "Change Status!",
                                text: "Sub specialities Status Change Sussessfully",
                                icon: "success",
                                dangerMode: true,
                                buttons: false,
                                timer: 1000
