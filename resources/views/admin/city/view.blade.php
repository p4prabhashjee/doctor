                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="search-form" method="post">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="from_date">Search City</label>
                                        <input type="text" name="title" class="form-control" placeholder="City">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="from_date">State</label>
                                ...
                                <div class="col-12">
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('city_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res == "Success") {
                        swal({
                                title: "Change Status!",
                                text: "City Status Change Sussessfully",
                                icon: "success",
                                dangerMode: true,
                                buttons: false,
                                timer: 1000
